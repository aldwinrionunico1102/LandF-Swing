...
Item Added Prompt Window
*/

package LostAndFoundMA3;

public class ItemMovedC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("The item has been moved successfully!");
    ...
    private void ButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonOKActionPerformed
        //Go to LFadminClaimed JFrame
        LFadminClaimed lfC = new LFadminClaimed();
        lfC.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ItemMovedC itemC = new ItemMovedC();
