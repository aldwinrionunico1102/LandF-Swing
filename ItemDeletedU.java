...
Item Deleted Prompt Window
*/

package LostAndFoundMA3;

public class ItemDeletedU extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("The item has been deleted successfully!");
    ...
    private void ButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonOKActionPerformed
        //Go to LFadminUnclaimed JFrame
        LFadminUnclaimed lfU = new LFadminUnclaimed();
        lfU.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ItemDeletedU itemC = new ItemDeletedU();
